...
/**
 * {@link ZNewFactory}クラスのテスト用クラスです。
 *
 *
 * @author 無線部開発班
 *
 * @since 2022/06/22
 */
public final class ZNewFactoryTest extends Assertions {
	private final ZNewFactory format = new ZNewFactory();
