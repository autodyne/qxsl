 ...
 * @since 2020/11/10
 */
public final class SyntaxOpTest extends Assertions {
	@ParameterizedTest
	@MethodSource("source")
	...
	private static final List<Arguments> source() throws Exception {
		...
		final var util = new AssetUtils(SyntaxOp.class);
		for (var line : util.listLines("SyntaxOp.lisp")) {
