...
(contest "ALLJA1 TEST"
	(section "1エリア内 個人 電信限定 1.9MHz部門"         (verify (内? CW? 1.9MHz? LB?)))
	(section "1エリア内 個人 電信限定 3.5MHz部門"         (verify (内? CW? 3.5MHz? LB?)))
	(section "1エリア内 個人 電信電話 3.5MHz部門"         (verify (内?     3.5MHz? LB?)))
	(section "1エリア内 個人 電信限定 7MHz部門"           (verify (内? CW?   7MHz? LB?)))
	(section "1エリア内 個人 電信電話 7MHz部門"           (verify (内?       7MHz? LB?)))
	(section "1エリア内 個人 電信限定 1.9/3.5/7MHz部門"   (verify (内? CW?         LB?)))
	(section "1エリア内 個人 電信電話 1.9/3.5/7MHz部門"   (verify (内?             LB?)))

	(section "1エリア外 個人 電信限定 1.9MHz部門"         (verify (外? CW? 1.9MHz? LB?)))
	(section "1エリア外 個人 電信限定 3.5MHz部門"         (verify (外? CW? 3.5MHz? LB?)))
	(section "1エリア外 個人 電信電話 3.5MHz部門"         (verify (外?     3.5MHz? LB?)))
	(section "1エリア外 個人 電信限定 7MHz部門"           (verify (外? CW?   7MHz? LB?)))
	(section "1エリア外 個人 電信電話 7MHz部門"           (verify (外?       7MHz? LB?)))
	(section "1エリア外 個人 電信限定 1.9/3.5/7MHz部門"   (verify (外? CW?         LB?)))
	(section "1エリア外 個人 電信電話 1.9/3.5/7MHz部門"   (verify (外?             LB?)))

	(section "1エリア内 個人 電信限定 14MHz部門"          (verify (内? CW?  14MHz? HB?)))
	(section "1エリア内 個人 電信電話 14MHz部門"          (verify (内?      14MHz? HB?)))
	(section "1エリア内 個人 電信限定 21MHz部門"          (verify (内? CW?  21MHz? HB?)))
	(section "1エリア内 個人 電信電話 21MHz部門"          (verify (内?      21MHz? HB?)))
	(section "1エリア内 個人 電信限定 28MHz部門"          (verify (内? CW?  28MHz? HB?)))
	(section "1エリア内 個人 電信電話 28MHz部門"          (verify (内?      28MHz? HB?)))
	(section "1エリア内 個人 電信限定 50MHz部門"          (verify (内? CW?  50MHz? HB?)))
	(section "1エリア内 個人 電信電話 50MHz部門"          (verify (内?      50MHz? HB?)))
	(section "1エリア内 個人 電信限定 14/21/28/50MHz部門" (verify (内? CW?         HB?)))
	(section "1エリア内 個人 電信電話 14/21/28/50MHz部門" (verify (内?             HB?)))

	(section "1エリア外 個人 電信限定 14MHz部門"          (verify (外? CW?  14MHz? HB?)))
	(section "1エリア外 個人 電信電話 14MHz部門"          (verify (外?      14MHz? HB?)))
	(section "1エリア外 個人 電信限定 21MHz部門"          (verify (外? CW?  21MHz? HB?)))
	(section "1エリア外 個人 電信電話 21MHz部門"          (verify (外?      21MHz? HB?)))
	(section "1エリア外 個人 電信限定 28MHz部門"          (verify (外? CW?  28MHz? HB?)))
	(section "1エリア外 個人 電信電話 28MHz部門"          (verify (外?      28MHz? HB?)))
	(section "1エリア外 個人 電信限定 50MHz部門"          (verify (外? CW?  50MHz? HB?)))
	(section "1エリア外 個人 電信電話 50MHz部門"          (verify (外?      50MHz? HB?)))
	(section "1エリア外 個人 電信限定 14/21/28/50MHz部門" (verify (外? CW?         HB?)))
	(section "1エリア外 個人 電信電話 14/21/28/50MHz部門" (verify (外?             HB?)))

	(section "1エリア内 団体 電信限定 部門"               (verify (内? CW?         AB?)))
	(section "1エリア内 団体 電信電話 部門"               (verify (内?             AB?)))
	(section "1エリア外 団体 電信限定 部門"               (verify (外? CW?         AB?)))
	(section "1エリア外 団体 電信電話 部門"               (verify (外?             AB?)))

	(section "1エリア内 個人 デジタル 部門"               (verify (内?       7MHz? DB?)))
	(section "1エリア外 個人 デジタル 部門"               (verify (外?       7MHz? DB?)))
	(section "1エリア内 団体 デジタル 部門"               (verify (内?       7MHz? DB?)))
	(section "1エリア外 団体 デジタル 部門"               (verify (外?       7MHz? DB?))))
