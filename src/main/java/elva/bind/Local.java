 ...
 * @since 2017/02/18
 */
public final class Local extends SimpleBindings {
	...
	public final ElvaNode get(Object name) {
		...
		} else return new Types(null).get(name);
	}
	 ...
	 * @param form 登録する関数
	 */
	public final void put(ElvaForm form) {
	 ...
	 * @param sexp 値
	 */
	public final void put(ElvaName name, ElvaNode sexp) {
	 ...
	 * @return この環境
	 */
	public final Local merge(Bindings nest) {
